...
def help():
    ...
    print("from scripts.deploy_registry import get_accounts, get_stakeholder_accounts")
    print("a = get_accounts()")
    print("stakeholder_accounts = get_stakeholder_accounts(a)")
    print("staking = contract_from_address(StakingV02, '0x88972600b4Ca9E5601830EfDD6f561e619E74Be8')")
    print("dip = contract_from_address(interface.IERC20Metadata, staking.getDip())")
    print("registry = contract_from_address(ChainRegistryV01, staking.getRegistry())")
    print("bundle_nft_id=registry.getNftId(registry.toChain(web3.chain_id), registry.BUNDLE(), 0)")
    print("instance_operator = stakeholder_accounts['instanceOperator']")
    print("staker = stakeholder_accounts['staker1']")
    print("staking_amount=1000*10**dip.decimals()")
    print("dip.transfer(staker, 100000*10**dip.decimals(), {'from': instance_operator})")
    print("dip.approve(staking, 100000*10**dip.decimals(), {'from': staker})")
    print("staking.createStake(bundle_nft_id, staking_amount, {'from': staker})")
